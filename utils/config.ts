...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Codeus was first started on this machine
  ...
  // Codeus usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Codeus OAuth token
  ...
  // Codeus hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
